...
import { buyCourse } from '../services/operation/StudentFeatureApi.js';
import { fetchCourseDetails } from '../services/operation/courseDetails.js';
import { setCourse } from '../slices/courseSlice.js';
import GetAvgRating from '../utils/avgRating.js';
import Error from "./Errror.jsx"
import ConfirmationModal from "../Components/common/ConfirmationModal.js"
import RatingStars from "../Components/common/ratingStar.js"
import { formatDate } from '../services/formateDate.js';
import { IoIosInformationCircleOutline } from 'react-icons/io';
import { BsGlobe } from 'react-icons/bs';
import { BiVideo } from 'react-icons/bi';
import { MdOutlineArrowForwardIos } from 'react-icons/md';
import CourseDetailsCard from '../Components/core/courseDetails/courseDetailsCard.js';
...
const CourseDetails = () => {
    ...
    const [avgReviewCount, setAvgReviewCount] = useState(0);
     ...
     console.log("course ka data",courseData);
    useEffect(() => {
    ...
    // console.log("course content",courseData.data.studentEnrolled);
  return (
    <>
                    ...
                    <div className='flex flex-col gap-3'>
                        <p className='text-[28px] font-semibold'>Course Content:</p>
                            ...
                            <div className='flex flex-wrap justify-between gap-2'>
                                ...
                                <span>{courseData.data.courseContent.length} section(s)</span>
